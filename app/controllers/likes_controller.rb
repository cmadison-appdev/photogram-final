class LikesController < ApplicationController
  ...
  def create
    ...
    if the_like.valid?
      ...
      redirect_to("/photos/#{params.fetch("query_photo_id")}", { :alert => "Like failed to create successfully." })
    end
  end
  ...
  def update
    ...
    the_like.fan_id = params.fetch("query_user_id")
    the_like.photo_id = params.fetch("query_photo_id")
  ...
  def destroy
    ...
    redirect_to("/", { :alert => "Like deleted successfully."} )
  end
end
